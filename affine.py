...
def compute_error_and_gradient(im1, im2, affine_parameters, translation_parameters, return_gradient=True):
    ...
    if not return_gradient:
        return E_data
    dIm_dphi1 = spline_dIm_dphi(im1, phi)
    dED_dphi1 = gradient.dED_dphit(im1, im2, phi, points, dIm_dphi1, 1)
...
def E_D_wrapper(im1, im2, parameters):
